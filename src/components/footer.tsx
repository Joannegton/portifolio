...
const socialLinks = [
  { icon: "github", href: "https://github.com/joannegton", label: "GitHub" },
  { icon: "linkedin", href: "https://www.linkedin.com/in/wellington-tavares-galbarini-21b915a9/", label: "LinkedIn" },
  { icon: Mail, href: "mailto:joannegton@gmail.com", label: "Email" },
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p className="text-sm text-muted-foreground flex items-center">
              © 2025 Joannegton. Desenvolvido com{" "}
              <motion.span
                className="mx-1"

...
const destaques = [
  ...
  },
  {
    ...
    descricao:
      "Formador de professores e mentor de alunos em tecnologia e matemática.",
  ...
  },
  {
    ...
    descricao:
      "Criador do Psy, terapeuta virtual com IA para suporte emocional e social.",
  ...
  },
  {
    ...
    descricao:
      "Gamificação, plataformas educacionais e uso de IA na aprendizagem.",
...
const formacaoAcademica = [
  ...
  },
  {
    ...
    ano: "2018-2020",
    descricao:
      "Formação pedagógica com ênfase em tecnologias educacionais e metodologias ativas",
  },
];
...
const experienciaProfissional = [
  {
    ...
    descricao:
      "Desenvolvimento de aplicações web e mobile, APIs RESTful e soluções em nuvem",
  },
  {
    ...
    descricao:
      "Ensino de matemática e programação para ensino médio, desenvolvimento de projetos interdisciplinares e lógica de programação",
  },
  {
    ...
    descricao:
      "Desenvolvimento de soluções personalizadas para educação, saúde mental entre outros setores, com foco em acessibilidade e inclusão digital",
  },
];
...
const valores = [
  ...
  },
  {
    ...
    descricao:
      "Comprometo-me com a qualidade técnica e a melhoria contínua em todos os projetos que desenvolvo.",
  },
];
...
const projetos: Projeto[] = [
  ...
  },
  {
    ...
    descricao:
      "Painel administrativo para visualização de dados com gráficos interativos e sistema de autenticação.",
    imagem: "/assets/api.jpg",
  ...
  },
  {
    ...
    descricao:
      "Aplicativo de apoio emocional com IA empática, capaz de conversar com o usuário, sugerir profissionais e promover o autocuidado.",
    ...
    github:
      "https://github.com/Joannegton/psy_terapeuta_virtual/tree/gemini-api", //arrumar no github para a main(desatualizada)
  ...
  },
  {
    ...
    descricao:
      "Material didático abrangente para ensino de criação de APIs com exercícios práticos e projetos reais, utilizados para palestrar sobre desenvolvimento backend na Universidade.",
